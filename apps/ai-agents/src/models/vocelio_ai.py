...
class VocelioAI:
    ...
    async def customer_conversation(self, prompt: str, context: list = None, priority: str = "quality") -> str:
        """
    ...
    async def lead_qualification(self, lead_data: str, criteria: str = None) -> dict:
        """
    ...
    async def strategic_planning(self, business_context: str, goals: str = None) -> dict:
        """
    ...
    async def campaign_optimization(self, campaign_data: str) -> dict:
        """
        Strategic campaign optimization using advanced reasoning
        """
    ...
    async def check_for_model_upgrades(self) -> dict:
        ...
        if "gpt-5" in new_models.get("models", {}):
            logger.info("🎉 GPT-5 detected! Adding to analysis tasks...")
            # GPT-5 would be added automatically by the orchestrator
...
async def chat_with_customer(message: str, context: list = None) -> str:
...
async def optimize_campaign(campaign_data: str) -> dict:
    """Quick campaign optimization"""
    return await vocelio_ai.campaign_optimization(campaign_data)
